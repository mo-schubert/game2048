...
public class TestGameSimpleMovement7 {
	...
	public void testMoveRight() {
		...
		assertEquals(2, cells[0][3].getTile().getValue());
		...
		assertEquals(2, cells[3][3].getTile().getValue());
	}
	...
	public void testMoveLeft() {
		...
		assertEquals(2, cells[3][2].getTile().getValue());
	...
	public void testMoveUp() {
		...
		assertEquals(null, cells[0][0].getTile());
		assertEquals(2, cells[0][1].getTile().getValue());
		assertEquals(2, cells[0][2].getTile().getValue());
		assertEquals(2, cells[0][3].getTile().getValue());

		assertEquals(null, cells[1][0].getTile());
		assertEquals(null, cells[1][1].getTile());
		assertEquals(4, cells[1][2].getTile().getValue());
		assertEquals(null, cells[1][3].getTile());
	...
	public void testMoveDown() {
		...
		assertEquals(null, cells[2][0].getTile());
		assertEquals(null, cells[2][1].getTile());
		assertEquals(2, cells[2][2].getTile().getValue());
		assertEquals(null, cells[2][3].getTile());
