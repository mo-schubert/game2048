...
public class TestGameSimpleMovement4 {
	...
	public void setUp() throws Exception {
		...
		cells[1][1].setTile(new GameTile(2));
	...
	public void testMoveUp() {
		...
		assertEquals(8, game.getCurrentGameState().getScore());
	}
	...
	public void testMoveDown() {
		...
		assertEquals(null, cells[2][0].getTile());
		assertEquals(4, cells[2][1].getTile().getValue());
		assertEquals(null, cells[2][2].getTile());
		assertEquals(null, cells[2][3].getTile());
